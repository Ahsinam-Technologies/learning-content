...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 409 --- MLOps - Productionising ML Systems}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Production ML lifecycle, automated training pipelines, model registries, drift detection (KS-test/PSI), A/B \\& shadow testing, and continuous monitoring.
\end{InsightBox}
