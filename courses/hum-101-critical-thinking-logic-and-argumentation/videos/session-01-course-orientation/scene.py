...
Course: HUM 101 - Critical Thinking, Logic & Argumentation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for HUM 101 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("HUM 101: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Critical Thinking, Logic & Argumentation\n\nSession Goal: Establish fundamental definitions & invariants.",
