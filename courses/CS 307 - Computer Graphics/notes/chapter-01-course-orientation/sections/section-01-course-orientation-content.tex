...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 307 --- Computer Graphics}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Rasterization, 3D transformations, shading models, ray tracing, OpenGL/Vulkan, shaders, and GPU pipeline rendering.
\end{InsightBox}
