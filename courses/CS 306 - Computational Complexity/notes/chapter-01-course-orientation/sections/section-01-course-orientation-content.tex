...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 306 --- Computational Complexity}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Complexity classes (P, NP, co-NP, BPP, PSPACE, EXPTIME), polynomial-time reductions, Cook-Levin theorem, interactive proofs, and hardness of approximation.
\end{InsightBox}
