...
Course: QF 502 - Financial Econometrics & High-Frequency | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 502 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 502: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Financial Econometrics & High-Frequency\n\nSession Goal: Establish fundamental definitions & invariants.",
