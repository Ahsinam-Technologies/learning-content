...
Course: ECO 401 - Industrial Organisation - Competition, Strategy & Regulation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ECO 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ECO 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Industrial Organisation - Competition, Strategy & Regulation\n\nSession Goal: Establish fundamental definitions & invariants.",
