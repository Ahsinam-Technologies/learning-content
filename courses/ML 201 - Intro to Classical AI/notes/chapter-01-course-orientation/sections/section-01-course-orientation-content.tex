...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 201 --- Intro to Classical AI}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Search algorithms (A*, minimax, alpha-beta pruning), constraint satisfaction, knowledge representation, and expert systems.
\end{InsightBox}
