...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 103 --- Classical ML II - Unsupervised}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Dimensionality reduction (PCA), clustering (K-Means, DBSCAN, Hierarchical), Silhouette analysis, and anomaly detection.
\end{InsightBox}
