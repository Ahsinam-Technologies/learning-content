...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 204 --- Software Testing I}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Test-driven development (TDD), unit testing with pytest, mocking, code coverage, regression testing, and data validation testing.
\end{InsightBox}
