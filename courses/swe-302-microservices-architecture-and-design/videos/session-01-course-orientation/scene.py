...
Course: SWE 302 - Microservices Architecture & Design | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 302 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 302: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Microservices Architecture & Design\n\nSession Goal: Establish fundamental definitions & invariants.",
