...
Course: QF 402 - Portfolio Theory | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 402 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 402: Session 01", "Course Orientation")
