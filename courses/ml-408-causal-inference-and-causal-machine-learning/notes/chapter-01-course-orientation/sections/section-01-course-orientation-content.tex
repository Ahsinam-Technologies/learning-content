...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 408 --- Causal Inference \& Causal Machine Learning}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Structural causal models, DAGs, do-calculus, potential outcomes, propensity score matching, and instrumental variables.
\end{InsightBox}
