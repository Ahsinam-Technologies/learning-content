...
Course: ML 408 - Causal Inference & Causal Machine Learning | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 408 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 408: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Causal Inference & Causal Machine Learning\n\nSession Goal: Establish fundamental definitions & invariants.",
