...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 301 --- Real Analysis}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Rigorous epsilon-delta limits, sequences, Bolzano-Weierstrass theorem, metric spaces, compactness, completeness, and Riemann integration.
\end{InsightBox}
