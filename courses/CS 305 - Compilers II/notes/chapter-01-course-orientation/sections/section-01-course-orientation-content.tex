...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 305 --- Compilers II}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Code generation, machine-dependent and machine-independent optimizations, loop vectorization, JIT compilation, and ML graph compilation (XLA, TVM, Triton).
\end{InsightBox}
