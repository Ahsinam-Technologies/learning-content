...
Course: SWE 403 - Data Engineering - Pipelines, Warehousing & Stream | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 403 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 403: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Data Engineering - Pipelines, Warehousing & Stream\n\nSession Goal: Establish fundamental definitions & invariants.",
