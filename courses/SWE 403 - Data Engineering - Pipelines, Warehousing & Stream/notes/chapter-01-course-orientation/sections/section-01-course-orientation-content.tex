...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 403 --- Data Engineering - Pipelines, Warehousing \& Stream}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Distributed compute engines (Apache Spark / PySpark), columnar formats (Parquet), data lake architectures, DQDL quality gates, and Athena/Glue.
\end{InsightBox}
