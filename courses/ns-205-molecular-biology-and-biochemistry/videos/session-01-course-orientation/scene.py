...
Course: NS 205 - Molecular Biology & Biochemistry | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 205 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 205: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Molecular Biology & Biochemistry\n\nSession Goal: Establish fundamental definitions & invariants.",
