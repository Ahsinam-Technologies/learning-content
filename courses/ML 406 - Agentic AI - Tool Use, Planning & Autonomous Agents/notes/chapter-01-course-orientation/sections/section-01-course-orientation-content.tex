...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 406 --- Agentic AI - Tool Use, Planning \& Autonomous Agents}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: ReAct reasoning loops, OpenAPI 3.0 tool schemas, function calling, stateful orchestration, and multi-step autonomous workflows.
\end{InsightBox}
