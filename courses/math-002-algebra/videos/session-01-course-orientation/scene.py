...
Course: MATH 002 - Algebra | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 002 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 002: Session 01", "Course Orientation")
