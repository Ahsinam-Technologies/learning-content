...
Course: CS 501 - Quantum Computing & Quantum Algorithms | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 501 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 501: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Quantum Computing & Quantum Algorithms\n\nSession Goal: Establish fundamental definitions & invariants.",
