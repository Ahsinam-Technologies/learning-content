...
Course: ML 501 - Generative Models - Advanced Diffusion & Flow Matching | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 501 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 501: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Generative Models - Advanced Diffusion & Flow Matching\n\nSession Goal: Establish fundamental definitions & invariants.",
