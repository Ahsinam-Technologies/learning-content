...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 304 --- Bayesian Machine Learning}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Bayesian linear/logistic regression, conjugate priors, Gaussian Processes, Bayesian Optimization, Markov Chain Monte Carlo (Metropolis-Hastings, Gibbs sampling), and Variational Inference.
\end{InsightBox}
