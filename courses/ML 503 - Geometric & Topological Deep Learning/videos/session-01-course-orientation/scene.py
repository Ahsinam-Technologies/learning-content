...
Course: ML 503 - Geometric & Topological Deep Learning | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 503 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 503: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Geometric & Topological Deep Learning\n\nSession Goal: Establish fundamental definitions & invariants.",
