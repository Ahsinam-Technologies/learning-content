...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 101 --- Calculus I - Single Variable}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Limits, continuity, differentiation, rate of change, tangents, single-variable optimization, and Taylor series.
\end{InsightBox}
