...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 404 --- Advanced Computer Architecture \& GPU Computing}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: GPU microarchitectures, CUDA programming model, thread warps, shared memory, memory coalescing, Tensor Cores, mixed-precision arithmetic, and FlashAttention kernel optimization.
\end{InsightBox}
