...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 303 --- Database Systems II}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Distributed database systems, query optimization \\& cost estimation, columnar execution engines (Parquet/Arrow), analytical databases (OLAP), and distributed transactions.
\end{InsightBox}
