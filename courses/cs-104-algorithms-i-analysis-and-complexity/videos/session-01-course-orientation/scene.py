...
Course: CS 104 - Algorithms I - Analysis & Complexity | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 104 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 104: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Algorithms I - Analysis & Complexity\n\nSession Goal: Establish fundamental definitions & invariants.",
