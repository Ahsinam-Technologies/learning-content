...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 405 --- Retrieval-Augmented Generation \& Vector Databases}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Dense vector embeddings, approximate nearest neighbor search (HNSW), vector databases (OpenSearch), hybrid retrieval, and RAG architectures.
\end{InsightBox}
