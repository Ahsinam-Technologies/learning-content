...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 308 --- Human-Computer Interaction}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: User experience design, usability testing, human cognitive constraints, interactive visualization, and interface evaluation.
\end{InsightBox}
