...
Course: HUM 302 - Sociology of Innovation - Diffusion, Adoption & Technology & Society | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for HUM 302 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("HUM 302: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Sociology of Innovation - Diffusion, Adoption & Technology & Society\n\nSession Goal: Establish fundamental definitions & invariants.",
