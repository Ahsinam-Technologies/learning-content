...
Course: ML 410 - AI Safety, Alignment & Robustness | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 410 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 410: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: AI Safety, Alignment & Robustness\n\nSession Goal: Establish fundamental definitions & invariants.",
