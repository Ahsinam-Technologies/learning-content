...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 401 --- Speech Recognition \& Audio Processing}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Acoustic feature extraction (Spectrograms, MFCCs), Hidden Markov Models, CTC loss, neural speech recognition (Whisper, Conformer), text-to-speech, and audio generative models.
\end{InsightBox}
