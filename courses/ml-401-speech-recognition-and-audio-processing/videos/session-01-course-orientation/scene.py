...
Course: ML 401 - Speech Recognition & Audio Processing | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Speech Recognition & Audio Processing\n\nSession Goal: Establish fundamental definitions & invariants.",
