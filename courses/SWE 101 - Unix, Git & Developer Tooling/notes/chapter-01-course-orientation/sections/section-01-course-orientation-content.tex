...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 101 --- Unix, Git \& Developer Tooling}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: POSIX terminal navigation, bash scripting, Git internals (trees/commits), branching, and developer environments.
\end{InsightBox}
