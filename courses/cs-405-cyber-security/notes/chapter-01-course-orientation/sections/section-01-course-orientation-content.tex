...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 405 --- Cyber Security}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Cryptographic protocols, PKI, authentication/authorization mechanisms, threat modeling, attack surfaces, and defense-in-depth security architectures.
\end{InsightBox}
