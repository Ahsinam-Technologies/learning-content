...
Course: NS 302 - Condensed Matter Physics & Materials Science | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 302 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 302: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Condensed Matter Physics & Materials Science\n\nSession Goal: Establish fundamental definitions & invariants.",
