...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 301 --- NLP II - Deep Learning based NLP}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Word embeddings (Word2Vec, FastText, GloVe), Recurrent NLP models (BiLSTM-CRF), sequence-to-sequence models with attention, and subword tokenization algorithms.
\end{InsightBox}
