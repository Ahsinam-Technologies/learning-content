...
Course: ML 301 - NLP II - Deep Learning based NLP | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 301: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: NLP II - Deep Learning based NLP\n\nSession Goal: Establish fundamental definitions & invariants.",
