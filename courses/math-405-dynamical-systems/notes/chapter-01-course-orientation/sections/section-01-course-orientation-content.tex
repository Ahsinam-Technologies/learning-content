...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 405 --- Dynamical Systems}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Phase space analysis, stability theory, Lyapunov functions, limit cycles, bifurcation theory, chaotic systems, and gradient flow dynamics in deep learning.
\end{InsightBox}
