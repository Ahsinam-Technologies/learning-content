...
Course: QF 202 - Equity Valuation & Security Analysis | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 202 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 202: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Equity Valuation & Security Analysis\n\nSession Goal: Establish fundamental definitions & invariants.",
