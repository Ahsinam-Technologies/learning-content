...
Course: ML 505 - Foundations of AGI & Frontier AI Research | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 505 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 505: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Foundations of AGI & Frontier AI Research\n\nSession Goal: Establish fundamental definitions & invariants.",
