...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 305 --- Topology}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Topological spaces, open/closed sets, basis, continuity, homeomorphisms, compactness, connectedness, product topology, and metric topologies.
\end{InsightBox}
