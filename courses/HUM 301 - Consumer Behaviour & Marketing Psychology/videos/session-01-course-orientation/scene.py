...
Course: HUM 301 - Consumer Behaviour & Marketing Psychology | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for HUM 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("HUM 301: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Consumer Behaviour & Marketing Psychology\n\nSession Goal: Establish fundamental definitions & invariants.",
