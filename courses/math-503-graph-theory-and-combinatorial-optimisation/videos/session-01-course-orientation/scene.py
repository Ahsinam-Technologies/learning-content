...
Course: MATH 503 - Graph Theory & Combinatorial Optimisation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 503 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 503: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Graph Theory & Combinatorial Optimisation\n\nSession Goal: Establish fundamental definitions & invariants.",
