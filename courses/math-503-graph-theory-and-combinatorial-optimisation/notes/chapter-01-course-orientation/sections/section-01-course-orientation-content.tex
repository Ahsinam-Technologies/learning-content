...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 503 --- Graph Theory \& Combinatorial Optimisation}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Graph topologies, trees, matchings, network flows, min-cut max-flow theorem, graph Laplacian, spectral graph theory, and NP-hard combinatorial optimization.
\end{InsightBox}
