...
Course: SWE 203 - Mobile Application Development | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 203 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 203: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Mobile Application Development\n\nSession Goal: Establish fundamental definitions & invariants.",
