...
Course: MATH 404 - Optimisation Theory II - Non-Convex & Advanced Optimisation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 404 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 404: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Optimisation Theory II - Non-Convex & Advanced Optimisation\n\nSession Goal: Establish fundamental definitions & invariants.",
