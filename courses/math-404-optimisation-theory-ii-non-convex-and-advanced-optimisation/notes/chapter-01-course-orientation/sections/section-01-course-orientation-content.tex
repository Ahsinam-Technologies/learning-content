...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 404 --- Optimisation Theory II - Non-Convex \& Advanced Optimisation}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Non-convex optimization landscapes, saddle points, stochastic gradient dynamics, Bayesian optimization, acquisition functions, and hyperparameter search.
\end{InsightBox}
