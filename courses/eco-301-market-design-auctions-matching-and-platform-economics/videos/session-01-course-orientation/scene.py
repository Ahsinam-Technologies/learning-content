...
Course: ECO 301 - Market Design - Auctions, Matching & Platform Economics | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ECO 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ECO 301: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Market Design - Auctions, Matching & Platform Economics\n\nSession Goal: Establish fundamental definitions & invariants.",
