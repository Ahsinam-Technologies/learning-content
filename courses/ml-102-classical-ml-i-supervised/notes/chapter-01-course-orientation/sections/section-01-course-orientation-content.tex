...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 102 --- Classical ML I - Supervised}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Linear/Logistic regression, regularization (Ridge/Lasso), decision trees, Random Forests, XGBoost/LightGBM, and evaluation metrics.
\end{InsightBox}
