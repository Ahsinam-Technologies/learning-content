...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 402 --- Large Language Models I - Architectures, Pre-training \& Scaling Laws}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Causal LM architectures, tokenization (BPE), scaling laws, autoregressive sampling (temperature, top-p, top-k), and structured JSON output.
\end{InsightBox}
