...
Course: CS 310 - Computer Security & Crypto Apps | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 310 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 310: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Computer Security & Crypto Apps\n\nSession Goal: Establish fundamental definitions & invariants.",
