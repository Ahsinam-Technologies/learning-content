...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 004 --- Trigonometry}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Trigonometric functions (sin, cos, tan), unit circle, trigonometric identities, law of sines/cosines, and inverse trigonometric functions.
\end{InsightBox}
