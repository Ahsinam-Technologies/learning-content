...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 105 --- Digital Logic Design}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Boolean algebra, logic gates, combinational and sequential logic, flip-flops, registers, ALUs, and digital circuit fundamentals. Prerequisite for Computer Architecture.
\end{InsightBox}
