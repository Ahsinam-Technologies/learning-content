...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 203 --- Classical Number Theory}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Divisibility, Euclidean algorithm, prime numbers, congruences, modular arithmetic, Fermat/Euler theorems, and primitive roots.
\end{InsightBox}
