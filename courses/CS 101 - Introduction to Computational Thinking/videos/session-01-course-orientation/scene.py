...
Course: CS 101 - Introduction to Computational Thinking | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 101 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 101: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Introduction to Computational Thinking\n\nSession Goal: Establish fundamental definitions & invariants.",
