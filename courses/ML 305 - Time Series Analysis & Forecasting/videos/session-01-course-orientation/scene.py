...
Course: ML 305 - Time Series Analysis & Forecasting | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 305 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 305: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Time Series Analysis & Forecasting\n\nSession Goal: Establish fundamental definitions & invariants.",
