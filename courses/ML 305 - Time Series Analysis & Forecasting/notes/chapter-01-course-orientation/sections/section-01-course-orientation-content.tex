...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 305 --- Time Series Analysis \& Forecasting}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Stationarity, ADF testing, trend/seasonality decomposition, ACF/PACF, ARIMA/SARIMAX, and autoregressive forecasting.
\end{InsightBox}
