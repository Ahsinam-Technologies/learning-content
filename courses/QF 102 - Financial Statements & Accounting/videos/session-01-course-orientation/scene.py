...
Course: QF 102 - Financial Statements & Accounting | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 102 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 102: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Financial Statements & Accounting\n\nSession Goal: Establish fundamental definitions & invariants.",
