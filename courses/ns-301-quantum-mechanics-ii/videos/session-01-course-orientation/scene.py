...
Course: NS 301 - Quantum Mechanics II | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 301: Session 01", "Course Orientation")
