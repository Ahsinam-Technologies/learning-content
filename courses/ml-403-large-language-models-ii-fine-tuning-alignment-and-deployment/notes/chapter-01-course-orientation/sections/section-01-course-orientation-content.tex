...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 403 --- Large Language Models II - Fine-tuning, Alignment \& Deployment}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Parameter-efficient fine-tuning (LoRA, QLoRA), instruction tuning, RLHF, DPO, quantization, and LLM serving frameworks.
\end{InsightBox}
