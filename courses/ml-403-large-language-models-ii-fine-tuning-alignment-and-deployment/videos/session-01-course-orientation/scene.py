...
Course: ML 403 - Large Language Models II - Fine-tuning, Alignment & Deployment | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 403 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 403: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Large Language Models II - Fine-tuning, Alignment & Deployment\n\nSession Goal: Establish fundamental definitions & invariants.",
