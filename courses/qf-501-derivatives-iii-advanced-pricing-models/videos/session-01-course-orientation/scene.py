...
Course: QF 501 - Derivatives III - Advanced Pricing Models | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 501 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 501: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Derivatives III - Advanced Pricing Models\n\nSession Goal: Establish fundamental definitions & invariants.",
