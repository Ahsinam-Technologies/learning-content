...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 502 --- Neural Architecture Search \& AutoML}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Automated machine learning (AutoML), evolutionary algorithms, differentiable architecture search (DARTS), hyperparameter optimization, and automated model selection.
\end{InsightBox}
