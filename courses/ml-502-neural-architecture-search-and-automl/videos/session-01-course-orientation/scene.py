...
Course: ML 502 - Neural Architecture Search & AutoML | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 502 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 502: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Neural Architecture Search & AutoML\n\nSession Goal: Establish fundamental definitions & invariants.",
