...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 102 --- Design Patterns I - Gang of Four}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Creational patterns (Factory, Singleton, Builder), Structural patterns (Adapter, Decorator, Composite, Facade), and Behavioral patterns (Observer, Strategy, State, Command).
\end{InsightBox}
