...
Course: SWE 102 - Design Patterns I - Gang of Four | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 102 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 102: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Design Patterns I - Gang of Four\n\nSession Goal: Establish fundamental definitions & invariants.",
