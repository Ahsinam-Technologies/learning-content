...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 105 --- Classical Probability}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Sample spaces, combinatorics, conditional probability, Bayes theorem, discrete/continuous random variables, expectation, and variance.
\end{InsightBox}
