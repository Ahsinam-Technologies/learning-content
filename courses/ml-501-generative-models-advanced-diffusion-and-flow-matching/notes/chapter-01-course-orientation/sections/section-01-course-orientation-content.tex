...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 501 --- Generative Models - Advanced Diffusion \& Flow Matching}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Denoising Diffusion Probabilistic Models (DDPM), Denoising Diffusion Implicit Models (DDIM), Continuous-time Score-based SDEs, Classifier-Free Guidance (CFG), Flow Matching, and Latent Diffusion Models.
\end{InsightBox}
