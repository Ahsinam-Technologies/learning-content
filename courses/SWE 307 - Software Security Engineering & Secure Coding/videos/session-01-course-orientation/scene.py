...
Course: SWE 307 - Software Security Engineering & Secure Coding | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 307 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 307: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Software Security Engineering & Secure Coding\n\nSession Goal: Establish fundamental definitions & invariants.",
