...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 302 --- Computer Vision II}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Deep convolutional networks (ResNet, ConvNeXt), object detection architectures (YOLO, Faster R-CNN), semantic/instance segmentation (U-Net, Mask R-CNN), and visual attention.
\end{InsightBox}
