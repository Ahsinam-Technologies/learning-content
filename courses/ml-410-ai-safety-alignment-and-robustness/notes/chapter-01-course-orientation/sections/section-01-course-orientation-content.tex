...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 410 --- AI Safety, Alignment \& Robustness}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Adversarial attacks, prompt injection defense, red-teaming, PII sanitization, Bedrock Guardrails, SHAP explainability, and bias auditing.
\end{InsightBox}
