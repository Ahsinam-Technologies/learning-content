...
Course: SWE 404 - Machine Learning Systems & MLOps | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 404 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 404: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Machine Learning Systems & MLOps\n\nSession Goal: Establish fundamental definitions & invariants.",
