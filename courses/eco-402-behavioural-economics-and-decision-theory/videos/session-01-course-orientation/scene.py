...
Course: ECO 402 - Behavioural Economics & Decision Theory | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ECO 402 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ECO 402: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Behavioural Economics & Decision Theory\n\nSession Goal: Establish fundamental definitions & invariants.",
