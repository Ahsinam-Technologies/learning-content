...
Course: SWE 305 - Cloud Engineering - AWS, Azure & GCP | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 305 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 305: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Cloud Engineering - AWS, Azure & GCP\n\nSession Goal: Establish fundamental definitions & invariants.",
