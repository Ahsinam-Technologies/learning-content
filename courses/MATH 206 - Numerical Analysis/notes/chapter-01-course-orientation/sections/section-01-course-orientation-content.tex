...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 206 --- Numerical Analysis}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Floating-point arithmetic, error propagation, condition numbers, root finding algorithms, numerical integration, and iterative matrix solvers.
\end{InsightBox}
