...
Course: ML 504 - Advanced Reinforcement Learning - Multi-Agent & Hierarchical RL | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 504 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 504: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Advanced Reinforcement Learning - Multi-Agent & Hierarchical RL\n\nSession Goal: Establish fundamental definitions & invariants.",
