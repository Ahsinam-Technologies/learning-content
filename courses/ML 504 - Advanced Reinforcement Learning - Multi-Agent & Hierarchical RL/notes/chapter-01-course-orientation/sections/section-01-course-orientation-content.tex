...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 504 --- Advanced Reinforcement Learning - Multi-Agent \& Hierarchical RL}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Multi-agent RL (MARL), game-theoretic equilibria, hierarchical reinforcement learning (options framework), model-based RL (World Models), and offline RL.
\end{InsightBox}
