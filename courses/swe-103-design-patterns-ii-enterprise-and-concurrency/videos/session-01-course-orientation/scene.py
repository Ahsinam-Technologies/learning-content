...
Course: SWE 103 - Design Patterns II - Enterprise & Concurrency | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 103 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 103: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Design Patterns II - Enterprise & Concurrency\n\nSession Goal: Establish fundamental definitions & invariants.",
