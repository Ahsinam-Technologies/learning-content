...
This document establishes the official academic reading material and syllabus scope for \textbf{ECO 201 --- Game Theory I - Strategic Decision Making}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Normal-form games, Nash equilibrium, dominant strategies, extensive-form games, subgame perfection, Bayesian games, and cost-utility decision theory under uncertainty.
\end{InsightBox}
