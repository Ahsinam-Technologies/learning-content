...
Course: ML 406 - Agentic AI - Tool Use, Planning & Autonomous Agents | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 406 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 406: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Agentic AI - Tool Use, Planning & Autonomous Agents\n\nSession Goal: Establish fundamental definitions & invariants.",
