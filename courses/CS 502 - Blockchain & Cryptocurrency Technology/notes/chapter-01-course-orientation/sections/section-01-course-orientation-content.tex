...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 502 --- Blockchain \& Cryptocurrency Technology}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Decentralized ledgers, consensus protocols (PoW, PoS), smart contracts, cryptography in blockchains, and distributed ledger scalability.
\end{InsightBox}
