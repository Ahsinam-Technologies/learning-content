...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 206 --- Computer Vision I}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Image representation, convolution kernels, edge detection, feature descriptors (SIFT/ORB), and classic vision filtering.
\end{InsightBox}
