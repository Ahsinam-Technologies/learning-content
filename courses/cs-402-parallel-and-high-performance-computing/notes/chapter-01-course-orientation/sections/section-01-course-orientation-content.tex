...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 402 --- Parallel \& High-Performance Computing}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Parallel hardware architectures, shared vs distributed memory, OpenMP multi-threading, MPI message passing, communication overheads, Amdahl and Gustafson laws.
\end{InsightBox}
