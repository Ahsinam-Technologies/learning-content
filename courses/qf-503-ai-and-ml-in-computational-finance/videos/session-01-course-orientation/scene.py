...
Course: QF 503 - AI & ML in Computational Finance | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 503 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 503: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: AI & ML in Computational Finance\n\nSession Goal: Establish fundamental definitions & invariants.",
