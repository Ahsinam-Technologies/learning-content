...
Course: SWE 401 - Advanced Software Architecture - Event-Driven & Reactive | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Advanced Software Architecture - Event-Driven & Reactive\n\nSession Goal: Establish fundamental definitions & invariants.",
