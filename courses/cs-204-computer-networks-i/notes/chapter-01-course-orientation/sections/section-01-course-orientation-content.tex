...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 204 --- Computer Networks I}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: OSI and TCP/IP stack, socket programming, HTTP/HTTPS, DNS, routing algorithms, transport layer protocols (TCP/UDP), and network security.
\end{InsightBox}
