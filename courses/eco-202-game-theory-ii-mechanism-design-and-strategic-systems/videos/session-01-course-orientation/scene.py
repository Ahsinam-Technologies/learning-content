...
Course: ECO 202 - Game Theory II - Mechanism Design & Strategic Systems | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ECO 202 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ECO 202: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Game Theory II - Mechanism Design & Strategic Systems\n\nSession Goal: Establish fundamental definitions & invariants.",
