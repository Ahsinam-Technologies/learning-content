...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 005 --- Cartesian Geometry}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Coordinate planes, lines, distance formula, conic sections (circles, parabolas, ellipses, hyperbolas), and parametric curves.
\end{InsightBox}
