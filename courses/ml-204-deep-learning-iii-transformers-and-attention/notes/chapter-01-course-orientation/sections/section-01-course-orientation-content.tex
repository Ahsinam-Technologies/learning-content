...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 204 --- Deep Learning III - Transformers \& Attention}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Self-attention, Multi-Head Attention mechanisms, Query-Key-Value matrices, positional encodings, and Transformer architectures.
\end{InsightBox}
