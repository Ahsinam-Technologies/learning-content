...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 205 --- NLP I - Classical \& Statistical}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Text preprocessing, N-grams, TF-IDF vectorization, language modeling, Hidden Markov Models, and classical sentiment analysis.
\end{InsightBox}
