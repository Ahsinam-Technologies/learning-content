...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 201 --- Web Development I - Frontend}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: HTML5, CSS3, modern JavaScript/TypeScript, DOM manipulation, responsive UI design, frontend frameworks, and browser networking.
\end{InsightBox}
