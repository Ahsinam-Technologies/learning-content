...
Course: CS 401 - Algorithms III - Randomised & Approximation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Algorithms III - Randomised & Approximation\n\nSession Goal: Establish fundamental definitions & invariants.",
