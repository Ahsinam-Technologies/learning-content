...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 205 --- Database Systems I}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Relational database theory, SQL DDL/DML, B-Tree indexing, ACID transactions, normalization, and NoSQL data modeling.
\end{InsightBox}
