...
Course: CS 502 - Blockchain & Cryptocurrency Technology | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 502 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 502: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Blockchain & Cryptocurrency Technology\n\nSession Goal: Establish fundamental definitions & invariants.",
