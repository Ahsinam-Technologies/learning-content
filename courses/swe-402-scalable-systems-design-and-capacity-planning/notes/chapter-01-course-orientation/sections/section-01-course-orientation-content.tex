...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 402 --- Scalable Systems Design \& Capacity Planning}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: High-availability system design, load balancing, caching topologies, capacity estimation, and horizontal scaling.
\end{InsightBox}
