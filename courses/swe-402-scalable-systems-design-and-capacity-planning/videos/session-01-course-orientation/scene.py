...
Course: SWE 402 - Scalable Systems Design & Capacity Planning | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 402 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 402: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Scalable Systems Design & Capacity Planning\n\nSession Goal: Establish fundamental definitions & invariants.",
