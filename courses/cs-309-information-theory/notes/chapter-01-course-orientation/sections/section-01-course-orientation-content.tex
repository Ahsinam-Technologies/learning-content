...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 309 --- Information Theory}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Shannon entropy, joint \\& conditional entropy, mutual information, Kullback-Leibler (KL) divergence, cross-entropy, channel capacity, rate-distortion theory, and asymptotic equipartition property.
\end{InsightBox}
