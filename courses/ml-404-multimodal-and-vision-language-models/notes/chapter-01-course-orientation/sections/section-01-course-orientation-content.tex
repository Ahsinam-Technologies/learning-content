...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 404 --- Multimodal \& Vision-Language Models}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Vision Transformers (ViT), cross-modal attention, OCR \\& document intelligence (Textract), and image-text reasoning.
\end{InsightBox}
