...
Course: ML 404 - Multimodal & Vision-Language Models | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 404 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 404: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Multimodal & Vision-Language Models\n\nSession Goal: Establish fundamental definitions & invariants.",
