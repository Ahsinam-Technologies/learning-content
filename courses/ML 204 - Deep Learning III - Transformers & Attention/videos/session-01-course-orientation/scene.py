...
Course: ML 204 - Deep Learning III - Transformers & Attention | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 204 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 204: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Deep Learning III - Transformers & Attention\n\nSession Goal: Establish fundamental definitions & invariants.",
