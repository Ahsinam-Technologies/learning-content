...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 103 --- Data Structures}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Arrays, linked lists, stacks, queues, hash tables, binary search trees, AVL/red-black trees, heaps, graphs, and memory management.
\end{InsightBox}
