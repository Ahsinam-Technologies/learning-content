...
Course: NS 406 - Quantum Information & Computation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 406 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 406: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Quantum Information & Computation\n\nSession Goal: Establish fundamental definitions & invariants.",
