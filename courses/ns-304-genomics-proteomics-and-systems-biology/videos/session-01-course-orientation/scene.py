...
Course: NS 304 - Genomics, Proteomics & Systems Biology | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 304 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 304: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Genomics, Proteomics & Systems Biology\n\nSession Goal: Establish fundamental definitions & invariants.",
