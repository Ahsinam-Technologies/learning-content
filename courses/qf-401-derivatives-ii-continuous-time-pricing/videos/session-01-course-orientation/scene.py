...
Course: QF 401 - Derivatives II - Continuous-time Pricing | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Derivatives II - Continuous-time Pricing\n\nSession Goal: Establish fundamental definitions & invariants.",
