...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 206 --- Software Architecture}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Architectural patterns, domain-driven design, modularity, reliability, AWS Well-Architected Framework, and trade-off analysis.
\end{InsightBox}
