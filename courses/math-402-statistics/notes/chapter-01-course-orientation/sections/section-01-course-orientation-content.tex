...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 402 --- Statistics}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Point estimation, Maximum Likelihood Estimation (MLE), hypothesis testing, confidence intervals, and regression inference.
\end{InsightBox}
