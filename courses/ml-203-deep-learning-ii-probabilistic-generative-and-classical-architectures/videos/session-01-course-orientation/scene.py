...
Course: ML 203 - Deep Learning II - Probabilistic, Generative & Classical Architectures | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 203 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 203: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Deep Learning II - Probabilistic, Generative & Classical Architectures\n\nSession Goal: Establish fundamental definitions & invariants.",
