...
Course: NS 303 - Computational Chemistry & Molecular Modelling | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 303 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 303: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Computational Chemistry & Molecular Modelling\n\nSession Goal: Establish fundamental definitions & invariants.",
