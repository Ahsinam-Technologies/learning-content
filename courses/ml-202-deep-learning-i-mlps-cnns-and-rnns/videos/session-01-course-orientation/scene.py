...
Course: ML 202 - Deep Learning I - MLPs, CNNs & RNNs | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 202 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 202: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Deep Learning I - MLPs, CNNs & RNNs\n\nSession Goal: Establish fundamental definitions & invariants.",
