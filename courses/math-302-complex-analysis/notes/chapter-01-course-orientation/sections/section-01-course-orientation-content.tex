...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 302 --- Complex Analysis}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Holomorphic functions, Cauchy-Riemann equations, contour integration, Cauchy integral formula, residue theorem, conformal mappings, and analytic continuation.
\end{InsightBox}
