...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 403 --- Functional Analysis}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Normed vector spaces, Banach spaces, Hilbert spaces, inner product spaces, bounded linear operators, dual spaces, Hahn-Banach theorem, Riesz representation theorem, and Reproducing Kernel Hilbert Spaces (RKHS).
\end{InsightBox}
