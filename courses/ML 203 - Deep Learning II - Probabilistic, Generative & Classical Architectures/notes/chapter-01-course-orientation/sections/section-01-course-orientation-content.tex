...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 203 --- Deep Learning II - Probabilistic, Generative \& Classical Architectures}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Autoencoders, Variational Autoencoders (VAEs), Normalizing Flows, Energy-based models, and probabilistic graphical neural models.
\end{InsightBox}
