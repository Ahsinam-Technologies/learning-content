...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 504 --- Cryptography \& Coding Theory}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Public-key cryptography (RSA, ECC), lattice-based cryptography, linear codes, error-correcting codes, and post-quantum cryptographic schemes.
\end{InsightBox}
