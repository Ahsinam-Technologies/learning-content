...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 403 --- Distributed Systems}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Distributed consensus (Paxos, Raft), vector clocks, distributed transactions, 2PC/3PC, gossip protocols, distributed storage, and fault tolerance.
\end{InsightBox}
