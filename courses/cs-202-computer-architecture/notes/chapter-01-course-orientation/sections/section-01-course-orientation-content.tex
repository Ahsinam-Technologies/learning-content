...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 202 --- Computer Architecture}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Digital logic, instruction set architecture (ISA), CPU pipelines, memory hierarchy, cache coherence, SIMD vectorization, and GPU architectures.
\end{InsightBox}
