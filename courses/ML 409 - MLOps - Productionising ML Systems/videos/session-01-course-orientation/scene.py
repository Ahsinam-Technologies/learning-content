...
Course: ML 409 - MLOps - Productionising ML Systems | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 409 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 409: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: MLOps - Productionising ML Systems\n\nSession Goal: Establish fundamental definitions & invariants.",
