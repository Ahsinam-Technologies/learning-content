...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 407 --- Optimisation for Machine Learning}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: First/second-order optimization, stochastic gradient descent variants (AdamW, RMSprop), line search, and non-convex landscape navigation.
\end{InsightBox}
