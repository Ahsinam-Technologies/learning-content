...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 301 --- Operating Systems II}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Advanced OS internals, kernel programming, virtualization, containerization (cgroups/namespaces), distributed file systems, and real-time scheduling.
\end{InsightBox}
