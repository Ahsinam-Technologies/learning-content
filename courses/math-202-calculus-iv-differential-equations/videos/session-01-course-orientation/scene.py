...
Course: MATH 202 - Calculus IV - Differential Equations | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 202 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 202: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Calculus IV - Differential Equations\n\nSession Goal: Establish fundamental definitions & invariants.",
