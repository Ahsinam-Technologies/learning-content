...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 202 --- Calculus IV - Differential Equations}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: First- and second-order ordinary differential equations (ODEs), linear systems of ODEs, phase plane analysis, and dynamical systems.
\end{InsightBox}
