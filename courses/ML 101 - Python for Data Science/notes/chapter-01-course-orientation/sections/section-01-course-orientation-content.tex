...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 101 --- Python for Data Science}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Vectorized computing with NumPy, tabular wrangling with Pandas, statistical visualization with Matplotlib/Seaborn, and EDA.
\end{InsightBox}
