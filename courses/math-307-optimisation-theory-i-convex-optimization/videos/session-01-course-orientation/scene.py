...
Course: MATH 307 - Optimisation Theory I - Convex Optimization | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 307 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 307: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Optimisation Theory I - Convex Optimization\n\nSession Goal: Establish fundamental definitions & invariants.",
