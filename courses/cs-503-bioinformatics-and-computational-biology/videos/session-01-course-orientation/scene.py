...
Course: CS 503 - Bioinformatics & Computational Biology | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 503 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 503: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Bioinformatics & Computational Biology\n\nSession Goal: Establish fundamental definitions & invariants.",
