...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 101 --- Introduction to Computational Thinking}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Algorithmic thinking, control flow, functions, recursion, complexity, and Python fundamentals.
\end{InsightBox}
