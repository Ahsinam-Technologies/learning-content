...
Course: HUM 401 - Ethics of Technology - AI, Privacy, Power & Governance | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for HUM 401 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("HUM 401: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Ethics of Technology - AI, Privacy, Power & Governance\n\nSession Goal: Establish fundamental definitions & invariants.",
