...
Course: CS 402 - Parallel & High-Performance Computing | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 402 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 402: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Parallel & High-Performance Computing\n\nSession Goal: Establish fundamental definitions & invariants.",
