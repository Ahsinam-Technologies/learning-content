...
Course: SWE 301 - Distributed Systems Engineering | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 301: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Distributed Systems Engineering\n\nSession Goal: Establish fundamental definitions & invariants.",
