...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 301 --- Distributed Systems Engineering}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: CAP theorem, consensus algorithms (Paxos, Raft), vector clocks, distributed transactions, fault tolerance, replication, and distributed consensus.
\end{InsightBox}
