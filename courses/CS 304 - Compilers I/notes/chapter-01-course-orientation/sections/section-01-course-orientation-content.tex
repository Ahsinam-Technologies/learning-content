...
This document establishes the official academic reading material and syllabus scope for \textbf{CS 304 --- Compilers I}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Lexical analysis, parsing techniques (LL, LR, LALR), abstract syntax trees (ASTs), semantic analysis, type checking, and intermediate representations (IR).
\end{InsightBox}
