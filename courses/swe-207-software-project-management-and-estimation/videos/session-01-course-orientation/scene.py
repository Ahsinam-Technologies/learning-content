...
Course: SWE 207 - Software Project Management & Estimation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 207 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 207: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Software Project Management & Estimation\n\nSession Goal: Establish fundamental definitions & invariants.",
