...
Course: CS 102 - Object-Oriented Programming | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 102 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 102: Session 01", "Course Orientation")
