...
Course: ECO 302 - Network Economics - Externalities, Two-Sided Markets & Platform Strategy | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ECO 302 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ECO 302: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Network Economics - Externalities, Two-Sided Markets & Platform Strategy\n\nSession Goal: Establish fundamental definitions & invariants.",
