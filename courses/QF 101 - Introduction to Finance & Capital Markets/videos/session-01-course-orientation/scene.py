...
Course: QF 101 - Introduction to Finance & Capital Markets | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 101 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 101: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Introduction to Finance & Capital Markets\n\nSession Goal: Establish fundamental definitions & invariants.",
