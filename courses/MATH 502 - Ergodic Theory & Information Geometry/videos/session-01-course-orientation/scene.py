...
Course: MATH 502 - Ergodic Theory & Information Geometry | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 502 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 502: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Ergodic Theory & Information Geometry\n\nSession Goal: Establish fundamental definitions & invariants.",
