...
Course: QF 301 - Derivatives I - Discrete-time Pricing | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for QF 301 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("QF 301: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Derivatives I - Discrete-time Pricing\n\nSession Goal: Establish fundamental definitions & invariants.",
