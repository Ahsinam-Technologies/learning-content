...
Course: CS 201 - Algorithms II - Design of Algorithms | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for CS 201 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("CS 201: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Algorithms II - Design of Algorithms\n\nSession Goal: Establish fundamental definitions & invariants.",
