...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 307 --- Optimisation Theory I - Convex Optimization}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Convex sets/functions, unconstrained/constrained optimization, Lagrange multipliers, KKT conditions, and gradient descent.
\end{InsightBox}
