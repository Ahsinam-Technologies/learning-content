...
Course: SWE 303 - Site Reliability Engineering (SRE) & Production Systems | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 303 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 303: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Site Reliability Engineering (SRE) & Production Systems\n\nSession Goal: Establish fundamental definitions & invariants.",
