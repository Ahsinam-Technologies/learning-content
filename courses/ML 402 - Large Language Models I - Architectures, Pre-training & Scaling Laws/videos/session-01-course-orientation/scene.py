...
Course: ML 402 - Large Language Models I - Architectures, Pre-training & Scaling Laws | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 402 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 402: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Large Language Models I - Architectures, Pre-training & Scaling Laws\n\nSession Goal: Establish fundamental definitions & invariants.",
