...
Course: ML 405 - Retrieval-Augmented Generation & Vector Databases | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for ML 405 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("ML 405: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Retrieval-Augmented Generation & Vector Databases\n\nSession Goal: Establish fundamental definitions & invariants.",
