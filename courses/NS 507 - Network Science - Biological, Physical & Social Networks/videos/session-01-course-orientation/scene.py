...
Course: NS 507 - Network Science - Biological, Physical & Social Networks | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 507 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 507: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Network Science - Biological, Physical & Social Networks\n\nSession Goal: Establish fundamental definitions & invariants.",
