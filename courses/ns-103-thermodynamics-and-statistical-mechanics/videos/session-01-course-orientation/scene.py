...
Course: NS 103 - Thermodynamics & Statistical Mechanics | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 103 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 103: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Thermodynamics & Statistical Mechanics\n\nSession Goal: Establish fundamental definitions & invariants.",
