...
This document establishes the official academic reading material and syllabus scope for \textbf{ML 503 --- Geometric \& Topological Deep Learning}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Equivariant neural networks, group convolution, manifold deep learning, gauge equivariance, topological data analysis (persistent homology), and physics-informed AI.
\end{InsightBox}
