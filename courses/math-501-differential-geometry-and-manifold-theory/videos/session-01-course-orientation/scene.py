...
Course: MATH 501 - Differential Geometry & Manifold Theory | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for MATH 501 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("MATH 501: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Differential Geometry & Manifold Theory\n\nSession Goal: Establish fundamental definitions & invariants.",
