...
Course: SWE 304 - Performance Engineering & Optimisation | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 304 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 304: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Performance Engineering & Optimisation\n\nSession Goal: Establish fundamental definitions & invariants.",
