...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 304 --- Performance Engineering \& Optimisation}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Performance profiling, CPU cache optimization, memory allocation and garbage collection tuning, asynchronous I/O, latency benchmarking, and kernel tuning.
\end{InsightBox}
