...
This document establishes the official academic reading material and syllabus scope for \textbf{MATH 401 --- Modern Probability Theory}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: Measure-theoretic probability foundations, convergence of random variables, Law of Large Numbers, and Central Limit Theorem.
\end{InsightBox}
