...
Course: SWE 202 - Web Development II - Backend & APIs | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for SWE 202 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("SWE 202: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Web Development II - Backend & APIs\n\nSession Goal: Establish fundamental definitions & invariants.",
