...
This document establishes the official academic reading material and syllabus scope for \textbf{SWE 202 --- Web Development II - Backend \& APIs}. Learners will engage with theoretical foundations, mathematical derivations, practical methodologies, and production-grade applications across the entire sequence.

\begin{InsightBox}{Official Syllabus Scope}
  \textbf{Curriculum Topics}: RESTful API architecture, FastAPI/Flask/Node.js, database integration, authentication/JWT, middleware, and ML model serving API wrappers.
\end{InsightBox}
