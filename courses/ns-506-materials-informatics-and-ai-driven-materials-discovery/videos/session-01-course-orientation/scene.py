...
Course: NS 506 - Materials Informatics & AI-Driven Materials Discovery | Session 01: Course Orientation
"""
import sys
import os
...
class SessionScene(BayesStackScene):
    """
    4-Scene Animation Script for NS 506 Session 01
    """
    ...
    def construct(self):
        ...
        title = self.create_title("NS 506: Session 01", "Course Orientation")
        card1 = self.create_card(
            title="Overview & Motivation",
            content="Course: Materials Informatics & AI-Driven Materials Discovery\n\nSession Goal: Establish fundamental definitions & invariants.",
